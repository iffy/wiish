...
| linux   | android       | opengl       |     No      |      Yes      |
| linux   | android       | plainwebview |     No      |      No       |
| linux   | android       | sdl2         |     No      |      Yes      |
| linux   | android       | webview      |     No      |      Yes      |
| linux   | mobiledev     | opengl       |     No      |       -       |
| linux   | mobiledev     | plainwebview |     No      |       -       |
| linux   | mobiledev     | sdl2         |     No      |       -       |
| linux   | mobiledev     | webview      |     No      |       -       |
| linux   | linux         | opengl       |     No      |      Yes      |
| linux   | linux         | plainwebview |     No      |      Yes      |
| linux   | linux         | sdl2         |     No      |      Yes      |
| linux   | linux         | webview      |     No      |      Yes      |
