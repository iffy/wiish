...
| mac     | android       | opengl       |     OK      |      OK       |
| mac     | android       | plainwebview |      x      |       x       |
| mac     | android       | sdl2         |     OK      |      OK       |
| mac     | android       | webview      |     OK      |      OK       |
| mac     | ios           | opengl       |      x      |       x       |
| mac     | ios           | plainwebview |      x      |       x       |
| mac     | ios           | sdl2         |      x      |       x       |
| mac     | ios           | webview      |      x      |       x       |
| mac     | ios-simulator | opengl       |      x      |      OK       |
| mac     | ios-simulator | plainwebview |      x      |       x       |
| mac     | ios-simulator | sdl2         |      x      |      OK       |
| mac     | ios-simulator | webview      |      x      |      OK       |
| mac     | mobiledev     | opengl       |      x      |       -       |
| mac     | mobiledev     | plainwebview |      x      |       -       |
| mac     | mobiledev     | sdl2         |      x      |       -       |
| mac     | mobiledev     | webview      |     OK      |       -       |
| mac     | mac           | opengl       |     OK      |      OK       |
| mac     | mac           | plainwebview |     OK      |      OK       |
| mac     | mac           | sdl2         |     OK      |      OK       |
| mac     | mac           | webview      |     OK      |      OK       |
